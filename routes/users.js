  ...
  .get(function(req, res) {
    mongoose.model('user').findById(req.id, function (err, user) {
      if (err) {
        ...
        var userdob = user.created.toISOString();
        ...
        if (err) {
            ...
            user.remove(function (err, user) {
                if (err) {
                    ...
                    //Returning success users saying it was deleted
                    ...
                    res.format({
                        //HTML returns us back to the main page, or you can create a success page
                         ...
                         //JSON returns the item with the user that is has been deleted
                        json: function(){
